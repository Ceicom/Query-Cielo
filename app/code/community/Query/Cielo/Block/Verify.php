...
class Query_Cielo_Block_Verify extends Mage_Checkout_Block_Onepage_Success
{
    ...
    public function getCieloDataHtml()
    {
		...
		else
		{
			...
			$html .= $this->__("Seu pagamento não foi realizado com sucesso.<br /> O TID da sua transação na Cielo é: <strong>") . 
					 $this->_cieloTid . 
					 $this->__("</strong>.<br />Mensagem de retorno da Cielo: <strong>") . 
					 $statusMsg . 
					 $this->__("</strong>.<br />br />Para maiores informações, por favor acesse o link do pedido acima ou entre em contato conosco.");
		}
